    ...
    <div id="modal1" class="modal">
        <div class="modal-content justify-content-center">
            ...
            <div class="slideshow-container">   
                ...
                <div class="mySlides fade">
                    <div class="modal-header text-center">
                        <h5 class="modal-title" id="modal7Label"> Keadaan Darurat di PT Anugrah Analisis Sempurna
                        </h5>
                    </div>
                ...
                <div class="mySlides fade">
                    <div class="modal-header text-center">
                        <h5 class="modal-title" id="modalevakuasi">Jalur Evakuasi</h5>
                    </div>
                    <div class="modal-body">
                ...
                <div class="mySlides fade">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="modaltitikkumpul">Titik Kumpul / Muster Point</h5>
                    </div>
                    <div class="modal-body">
                        <div class="row justify-content-center text-center">
                            <!-- Tambahkan kelas text-center di sini -->
                        ...
                        <div class="row justify-content-center"> <!-- Tambahkan kelas text-center di sini -->
                            <div class="col-md-6" style="font-size: 15px">
                                ...
                                <ol>
                                    ...
                                    <li>
                                        Senantiasa merahasiakan semua data, dokumen, catatan atau informasi
                                        dalam bentuk apapun yang diketahui atau diterima dari PT Anugrah
                                        Analisis Sempurna, dan tidak diperbolehkan untuk mengungkapkan,
                                        memperbanyak, menyebarluaskan, mengalihkan atau memberikan data tersebut
                                        kepada pihak lain tanpa persetujuan tertulis dari PT Anugrah Analisis
                                        Sempurna.
                                    </li>
                                    <li>
                                        Senantiasa mengambil langkah-langkah yang diperlukan untuk menyimpan,
                                        melindungi dan mengamankan semua data milik PT Anugrah Analisis Sempurna
                                        agar tidak dikuasai oleh pihak yang tidak bertanggungjawab.
                                    </li>
                                    <li>
                                        Apabila saya atau perusahaan/ instansi saya terbukti melakukan perbuatan
